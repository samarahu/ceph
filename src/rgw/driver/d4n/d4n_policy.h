...
class CachePolicy {
  ...
  public:
    ...
    virtual void update(const DoutPrefixProvider* dpp, const std::string& key, uint64_t offset, uint64_t len, const std::string &version, bool dirty, uint32_t refcount_flag, optional_yield y, std::string& restore_val=empty) = 0;
...
class LFUDAPolicy : public CachePolicy {
  ...
  public:
    ...
    virtual void update(const DoutPrefixProvider* dpp, const std::string& key, uint64_t offset, uint64_t len, const std::string& version, bool dirty, uint32_t refcount_flag, optional_yield y, std::string& restore_val=empty) override;
